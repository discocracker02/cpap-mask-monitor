...
def set_system_awake(prevent):
    """
    Prevent or allow Windows system sleep using SetThreadExecutionState.
    This keeps the system awake without changing any persistent settings.
    """
    try:
        if prevent:
        ...
        log(f"Warning: Could not set sleep state: {e}")
